...
function myModes() {
    ...
    const compets = document.getElementsByClassName('competition');
    ...
    if (a == 1) {
        ...
        for(compet of compets){
            compet.style.background = "linear-gradient(to right , #212121 , #212121)";
        }
        for(div of divTag){
            div.style.backgroundColor = "#212121";
            div.style.background = "linear-gradient(to right , #212121 , #212121)";
        }
        ...
        for(compet of compets){
            compet.style.background = "linear-gradient(to right , green , lightgreen)";
        }
